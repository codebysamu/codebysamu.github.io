...
const EMAILJS_PUBLIC_KEY  = 'CO11lyhpBuAD5Z0n0';   // ← paste here
const EMAILJS_SERVICE_ID  = 'service_3b3gtuy';   // ← paste here
const EMAILJS_TEMPLATE_ID = 'template_x1idfge';  // ← paste here
